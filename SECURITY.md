...
- Keep Playwright authentication state outside the repository in an owner-only directory and file; never upload authenticated traces, screenshots, videos, cookies, or share URLs.
