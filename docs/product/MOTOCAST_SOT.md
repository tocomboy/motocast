...
- Git: the latest committed correction is fixed SHA `c6d431b4ee25c8d71a84c5c633f3924e78b29d40`; a second correction for the remaining independent-review findings is currently uncommitted and is not yet approved. `.gitignore` remains a pre-existing user change and is excluded from MOTOCAST commits. No open PR or remote probe branch was present at the last live readback.
