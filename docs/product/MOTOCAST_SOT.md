...
- GitHub: public repository; default `develop`; `main` required checks `verify` and `develop-only`; PR required with zero approvals; administrators and conversation resolution enforced; force pushes and deletion disabled. Remote `develop` SHA `4d3f1c4314416137fb8d5ff9d2342404c488c90e` has successful CI run `33333315370`. Local `develop` contains rejected review SHA `9c66cc52e8c97a3b07642bcc0db0dd52e2ee4222`, approved correction SHA `51b6a071ac005efe3a1e692755f5369a1e432cd4`, and subsequent evidence-only documentation commits. These local commits have not been pushed or deployed.
