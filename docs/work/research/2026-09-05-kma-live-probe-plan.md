...
3. **완료:** 수정 SHA 0d18a27 독립 검토 APPROVE B0/H0/M0/L0와 비배포 PR #19 exact-head CI 33961430841 success를 확인했다. 기존 함수 변경 없이 새 임시 함수만 명시적 Preview에 배포했다.
4. **완료:** client 전송 1회·provider 3회 실행 후 소유 함수 삭제 200/부재 404 및 기존 다섯 함수 불변을 확인했다. [실측 결과](2026-09-05-kma-fixed-grid-observation.md)는 초단기 19:30→19:00, 18:30→18:00 FAIL, 단기 17:00→17:00 PASS다.
5. **후속 완료로 대체:** 당시 제품 계약 미확정 상태는 이후 사용자 승인·정시 실측과 [교정 및 Preview 연결 PASS](2026-09-05-kma-hour-correction-release.md)로 해소됐다. 아래 진단 계약과 실패 이력은 당시 범위의 기록이다.
