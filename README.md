...
0.2.2는 일부 경로 계획 실패의 원인을 확인하기 위한 진단 개선입니다. 전체 소요시간과 구간별 시간 합계가 다른 응답은 계속 거부하며, 원인과 실제 경로 성공 여부는 별도 확인 중입니다. [진단 범위와 검증 기록](docs/work/research/2026-09-16-route-duration-diagnostic.md)을 참조하세요.
